...
{       
            switch (Select_Alarm_Field)               // Decrement the proper field
            {
                case 0:
                    ...
                    else setup_alarm_hour = setup_alarm_hour - 1;
                    break;

                case 1:
                    // add code for alarm_minute decrement 
                    if (setup_alarm_minute == 0) setup_alarm_minute = 60;
                    else setup_alarm_minute = setup_alarm_minute - 1;
                    break;

                case 2:
                    // add code for alarm_second decrement    
                    if (setup_alarm_second == 0) setup_alarm_second = 60;
                    else setup_alarm_second = setup_alarm_second - 1;
                    break;
                default:
                break;
            }                
